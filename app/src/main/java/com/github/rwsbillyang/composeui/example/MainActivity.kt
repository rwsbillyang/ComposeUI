package com.github.rwsbillyang.composeui.example
...
import com.github.rwsbillyang.composeui.example.ui.theme.MyAppTheme
...
fun Screen1(call: ScreenCall) {
    Column(
        ...
        SimpleDataTable(
            listOf(
                ProColumn("Header1", {it[0]}),
                ProColumn("Header2", {it[1]}),
                ProColumn("Header3", {it[2]})
            ),
            listOf(
                listOf("item11", "item126666666666", "item13"),
                listOf("item21-777", "item22", "item23")
            )
        )
    }
}
